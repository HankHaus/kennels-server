from .animal_requests import get_all_animals, get_animals_by_status
from .animal_requests import get_single_animal, get_animals_by_location
...
from .employee_requests import get_all_employees, get_single_employee, get_employees_by_location
